...
| Formulario de registro con validaciones(https://alexander404-hz.github.io/Formulario-Validaciones/) | Formulario con validaciones nativas HTML5 (`required`, `pattern`, `min`/`max`) y buenas prácticas de accesibilidad. | HTML5, CSS3, JS |
